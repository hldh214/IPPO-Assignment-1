...
/**
 * Tests for the buggy proxy for the PictureViewer application.
 *
...
public class BuggyProxyTest implements Service {
    ...
    public void equalityTest() {
        ...
        assertSame("different picture returned for same subject (and index)", firstPicture, secondPicture);
    }
