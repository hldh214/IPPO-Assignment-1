...
public class HashMapController implements Controller {
    ...
    private HashMap<Integer, String> ippo_hm = new HashMap<>();
    ...
    public void start() {
        ...
        addSubject("Stob Binnein", view);
        addSubject("Gairich", view);
        addSubject("Ben Lomond", view);
        addSubject("Lochnagar", view);
    ...
    public void select(int selectionID) {
        ...
        picture = service.getPicture(ippo_hm.get(selectionID), 1);
